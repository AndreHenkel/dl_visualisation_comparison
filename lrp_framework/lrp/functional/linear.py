...
class LinearEpsilon0_01(Function):
    @staticmethod
    def forward(ctx, input, weight, bias=None):
        return _forward_rho(identity_fn, add_epsilon_fn(0.01), ctx, input, weight, bias) # TODO make batter way of choosing epsilon

    @staticmethod
    def backward(ctx, relevance_output):
        return _backward_rho(ctx, relevance_output)

class LinearEpsilon0(Function):
    @staticmethod
    def forward(ctx, input, weight, bias=None):
        return _forward_rho(identity_fn, add_epsilon_fn(0.0), ctx, input, weight, bias) # TODO make batter way of choosing epsilon

    @staticmethod
    def backward(ctx, relevance_output):
        return _backward_rho(ctx, relevance_output)

class LinearEpsilon100(Function):
    @staticmethod
    def forward(ctx, input, weight, bias=None):
        return _forward_rho(identity_fn, add_epsilon_fn(100), ctx, input, weight, bias) # TODO make batter way of choosing epsilon
...
linear = {
        ...
        "gradient":             F.linear,
        "epsilon0":             LinearEpsilon0.apply,
        "epsilon0_01":          LinearEpsilon0_01.apply,
        "epsilon100":           LinearEpsilon100.apply,
